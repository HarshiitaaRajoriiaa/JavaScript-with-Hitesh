...
*/
let name = "harshita" //string
let age = 21 //number
let id2 = "78abc"  //string
let girl = true //boolean
...
const name1 = "harh"
const name2 = "harh" 
console.log(name1==name2) //true value checking 
...
//! javascript documentation ->  https://262.ecma-international.org/5.1/#sec-11.4.3